        ...
        {actions.map((action: Action, i: any) => (
          ...
          >
            ...
            {action.is_error ? (
              ...
              <Badge variant="default" className="flex gap-2 bg-primary">
                <span>Done</span>
                <MdDone />
              </Badge>
            ...
            {action.is_converted ? (
              ...
              <span
                ...
                className="cursor-pointer hover:bg-secondary rounded-full h-10 w-10 flex items-center justify-center text-2xl"
              >
                <MdClose />
              </span>
            )}
  ...
  return (
    ...
    >
      {({ getRootProps, getInputProps }) => (
        <div
          {...getRootProps()}
          className="h-72 lg:h-80 xl:h-96 rounded-3xl shadow-sm border-2 border-dashed cursor-pointer flex items-center justify-center"
        >
          <input {...getInputProps()} />
